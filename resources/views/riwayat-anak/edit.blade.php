...
{!! Form::model($riwayat_anak, array('route' => array('riwayat-anak.update', $riwayat_anak->id), 'method' => 'PUT')) !!}
<div class="row">
    ...
    <div class="form-group">
		...
		{!! Form::text('tgl_lahir', date('d-m-Y', strtotime($riwayat_anak->tgl_lahir)), array('class' => 'form-control', 'id' => 'tgl_lahir')) !!}
		</div>
