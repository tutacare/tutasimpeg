...
<table class="table table-striped">
  ...
  <tr><td><strong>Pendidikan Terakhir:</strong></td><td>{{$jabatan->pendidikan_terakhir}}</td><td><strong>TGl. Pensiun:</strong></td><td>{{ date('d-m-Y', strtotime($kartu_induk_pegawai->tgl_pensiun)) }}</td><td>&nbsp;</td><td>&nbsp;</td></tr>
</table>
