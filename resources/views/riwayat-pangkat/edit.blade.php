...
@section('content')
<h3>Ganti Riwayat Pendidikan</h3>
{!! Html::ul($errors->all()) !!}
...
{!! Form::model($riwayat_pangkat, array('route' => array('riwayat-pangkat.update', $riwayat_pangkat->id), 'method' => 'PUT')) !!}
<div class="row">
	...
	<div class="col-md-6">
		...
		{!! Form::text('tgl_sk', date('d-m-Y', strtotime($riwayat_pangkat->tgl_sk)), array('class' => 'form-control', 'id' => 'tgl_sk')) !!}
		</div>
    ...
    <div class="form-group">
		...
		{!! Form::text('tmt_sk', date('d-m-Y', strtotime($riwayat_pangkat->tmt_sk)), array('class' => 'form-control', 'id' => 'tmt_sk')) !!}
		</div>
    <hr />
