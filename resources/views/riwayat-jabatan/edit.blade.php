...
{!! Form::model($riwayat_jabatan, array('route' => array('riwayat-jabatan.update', $riwayat_jabatan->id), 'method' => 'PUT')) !!}
<div class="row">
    ...
    <div class="form-group">
		...
		{!! Form::text('tgl_sk', date('d-m-Y', strtotime($riwayat_jabatan->tgl_sk)), array('class' => 'form-control', 'id' => 'tgl_sk')) !!}
		</div>

    <div class="form-group">
		{!! Form::label('tmt_sk', 'TMT. SK (dd-mm-yyyy)') !!}
		{!! Form::text('tmt_sk', date('d-m-Y', strtotime($riwayat_jabatan->tmt_sk)), array('class' => 'form-control', 'id' => 'tmt_sk')) !!}
		</div>
